...
<body class="scroll-smooth bg-gray-100 font-sans antialiased">
    <!-- Header avec une navigation sticky (fixée en haut de la page) -->
    <header class="sticky top-0 z-50">
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-6 dark:bg-gray-800">
            <!-- Contenu de la navigation, centré et espacé -->
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <!-- Bouton de contact et menu hamburger pour mobile -->
    ...
    <div class="md:hidden" id="mobileMenu" style="display: none;">
        <ul class="space-y-4 bg-gray-800 p-6 text-white">
            <!-- Lien vers la section Accueil (mobile) -->
            <li>
                <a href="#accueil" class="block py-2 px-4 text-white rounded-lg bg-indigo-700 hover:bg-indigo-800 transition-all duration-300 ease-in-out">
                    Accueil
                </a>
            </li>
            <!-- Lien vers la section Compétences (mobile) -->
            <li>
                <a href="#about" class="block py-2 px-4 text-white rounded-lg bg-indigo-700 hover:bg-indigo-800 transition-all duration-300 ease-in-out">
                    Compétences
                </a>
            </li>
            <!-- Lien vers la section Projets (mobile) -->
            <li>
                <a href="#projects" class="block py-2 px-4 text-white rounded-lg bg-indigo-700 hover:bg-indigo-800 transition-all duration-300 ease-in-out">
                    Projets
                </a>
            </li>
            <!-- Lien vers la section Actualités (mobile) -->
            <li>
                <a href="#actualite" class="block py-2 px-4 text-white rounded-lg bg-indigo-700 hover:bg-indigo-800 transition-all duration-300 ease-in-out">
                    Actualités
                </a>
            </li>
        </ul>
...
<section class="section" id="accueil">
    <!-- Section d'accueil avec une image et un texte central -->
    <div>
        <div class="flex h-screen items-center justify-center bg-gray-900 p-5">
            <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-10 md:px-10">
                <!-- Colonne de texte de présentation -->
                <div>
                    <h1 class="mb-2 text-3xl font-bold text-white">
                        <span class="text-green-500">Bonjour,</span> je suis apprenti Développeur Full Stack
                    </h1>
                    <p class="mb-6 text-white">
                        Je suis un jeune étudiant passionné d’informatique depuis mon enfance, avec pour objectif d’en faire mon métier à travers le développement applicatif. J’étudie actuellement en BTS SIO à <strong><a href='https://www.mewo.fr/' target='_blank'>Mewo</a></strong>. Vous pouvez télécharger mon CV ci-dessous.
                    </p>
                    <!-- Boutons de contact et téléchargement du CV -->
...
<!-- Section "À Propos de Moi" avec un gradient de fond -->
<section class="bg-gradient-to-b from-gray-100 to-gray-300 py-16 section" id="about">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <!-- Conteneur pour le cursus scolaire et les certifications -->
    ...
    <div class="py-16 px-6 max-w-6xl mx-auto">
        <div class="bg-white p-8 rounded-2xl shadow-lg relative">
            ...
            <div class="flex flex-nowrap gap-2 sm:absolute sm:top-6 sm:right-6">
                ...
                <!-- Conteneur des boutons radio pour filtrer les technologies -->
                <label for="front" class="font-medium flex items-center px-3 gap-3 rounded-lg relative w-32 h-14 hover:bg-zinc-100">
                    <div class="w-5"></div> Front
                    <input type="radio" name="status" class="peer/front w-4 h-4 absolute right-2 accent-current" id="front" />
                </label>

                <label for="back" class="font-medium flex items-center px-3 gap-3 rounded-lg relative w-32 h-14 hover:bg-zinc-100">
                    <div class="w-5"></div> Back
                    <input type="radio" name="status" class="w-4 h-4 absolute right-2 accent-current" id="back" />
                </label>

                <label for="tools" class="font-medium flex items-center px-3 gap-3 rounded-lg relative w-32 h-14 hover:bg-zinc-100">
                    <div class="w-5"></div> Outils
                    <input type="radio" name="status" class="w-4 h-4 absolute right-2 accent-blue-500" id="tools" />
                </label>
            </div>

            <!-- Message à afficher lorsqu'aucun domaine n'est sélectionné -->
            <p class="font-semibold text-red-700 text-center" id="message">Sélectionnez un domaine</p>

            <!-- Grille des logos des technologies -->
            <div class="grid grid-cols-3 sm:grid-cols-8 gap-10">
                <!-- Front-end -->
                ...
                <div class="w-auto p-3 border rounded-lg bg-white shadow-sm tools hidden">
                    <img src="assets/img/vscode.svg" alt="VS Code" class="w-16 h-16 mx-auto hover:scale-105 transition-transform duration-300">
                </div>
                <div class="w-auto p-3 border rounded-lg bg-white shadow-sm tools hidden">
...
<section id="projects" class="py-16 bg-gradient-to-b from-gray-100 to-gray-200 section">
    <!-- Conteneur principal avec un maximum de largeur définie -->
    <div class="max-w-6xl mx-auto px-6">
        <!-- En-tête de la section avec le titre et un sélecteur de projet -->
        <div class="flex justify-between items-center mb-12">
            <!-- Titre de la section "Mes Projets" -->
            <h2 class="text-5xl font-extrabold text-gray-800">Mes Projets</h2>
            <!-- Sélecteur pour filtrer les projets par catégorie -->
            <div class="w-64">
        ...
        <!-- Conteneur des projets avec une grille responsive -->
        <div id="projectContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Exemple de projet (à compléter dynamiquement ou avec des projets réels) -->
...
<section id="actualite" class="min-h-screen py-16 px-4 bg-gradient-to-b from-gray-100 to-gray-200">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <!-- Conteneur pour afficher les articles récupérés par tag -->
    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <!-- Titre principal de la section "Prendre contact" -->
                <h2 class="font-heading mb-4 font-bold tracking-tight text-gray-900 dark:text-white text-3xl sm:text-5xl">
                    Prendre contact
                </h2>
                <!-- Description sous le titre -->
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Restons connectés !</p>
            </div>
        </div>

        <!-- Conteneur pour la partie informations de contact et formulaire -->
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                ...
                <div class="h-full pr-6">
                    ...
                    <ul class="mb-6 md:mb-0">
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                <!-- Titre de l'adresse -->
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Adresse</h3>
                ...
                <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <?php
                    // Vérification du statut de succès dans l'URL et affichage d'un message de succès
...
</section><!-- Section de pied de page (footer) -->
<footer class="bg-gray-900 pt-12 pb-6 px-10 tracking-wide">
    <!-- Conteneur principal pour le footer -->
    <div class="max-w-screen-xl mx-auto">
        <!-- Grid pour la mise en page du footer -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <!-- Icônes des réseaux sociaux et téléchargement du CV -->
            <div class="lg:flex lg:items-center">
            ...
            <!-- Liens utiles pour la navigation interne -->
            <div>
            ...
            <div>
                ...
                <ul class="space-y-4 pl-2">
                    ...
                    <!-- Lien vers la section à propos de moi -->
                    <li>
